...
public class NetworkUtils {
     ...
     * @return
     */
    public static long getTotalRxBytes(Context cxt) {
        LogUtils.e("获取请求的数据总量--" + TrafficStats.getUidRxBytes(cxt.getApplicationInfo().uid));
        return TrafficStats.getUidRxBytes(cxt.getApplicationInfo().uid)
